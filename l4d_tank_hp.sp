...
ConVar hTankHPOn, hTankHPBasicTankHP, hTankHPAddTankHP, hDiffuculty;
...
public void OnPluginStart()
{
    ...
    hTankHPBasicTankHP = CreateConVar("l4d_tank_hp_basic_hp", "4000", "Tank basic health", CVAR_FLAGS);
    hTankHPAddTankHP = CreateConVar("l4d_tank_hp_add_hp", "1000", "each additional player Tank increases health", CVAR_FLAGS);
    ...
    hTankHPBasicTankHP.AddChangeHook(OnConVarsChanged);
    hTankHPAddTankHP.AddChangeHook(OnConVarsChanged);
}
...
{
	TankBasicHP = hTankHPBasicTankHP.IntValue;
	TankAddHP = hTankHPAddTankHP.IntValue;
}
