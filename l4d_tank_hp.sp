...
public void OnPluginStart()
{
    ...
    hBasicTankHP = CreateConVar("l4d_tank_hp_basic_hp", "4000", "Tank basic health", CVAR_FLAGS);
    hAddTankHP = CreateConVar("l4d_tank_hp_add_hp", "1000", "each additional player Tank increases health", CVAR_FLAGS);
